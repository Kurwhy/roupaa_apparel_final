                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:480px;background-color:#ffffff;border-radius:16px;overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:36px 32px 12px;">
                            ...
                            <h1 style="margin:0 0 16px;color:#111111;font-size:20px;font-weight:800;">Terima Kasih Telah Memesan!</h1>
                            <p style="margin:0 0 16px;color:#444444;font-size:14px;line-height:1.6;">
                                Pesanan "{{ $order->project_name }}" telah selesai diserahkan. Kami sangat menghargai kepercayaan Anda kepada ROUPAA Apparel.
                            </p>
                            <p style="margin:0 0 24px;color:#444444;font-size:14px;line-height:1.6;">
                                Invoice lengkap untuk pesanan ini telah kami lampirkan pada email ini sebagai bukti transaksi.
                            </p>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="padding:20px 32px;background-color:#fafafa;border-top:1px solid #eeeeee;">
                            <p style="margin:0;color:#999999;font-size:11px;line-height:1.6;">Sampai jumpa di pesanan berikutnya. Email ini dikirim otomatis oleh sistem ROUPAA Apparel.</p>
                        </td>
                    </tr>
                </table>
            </td>
